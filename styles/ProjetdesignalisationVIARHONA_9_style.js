...
var style_ProjetdesignalisationVIARHONA_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var bufferColor = "#f6fa52";
    var bufferWidth = 3.0;
    var textAlign = "left";
    var offsetX = 0;
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("IDENTIFIANT") !== null) {
        labelText = String(feature.get("IDENTIFIANT"));
    }
